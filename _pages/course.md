...
toc:
  ...
  - name: CS61A
  - name: CS106L standard C++ programming
...
| four fundamental subspaces                |   ✅    | `note.10`  |
| matrix spaces, rank 1, small world graphs |   ✅    | `note1.11` |
| graphs, networks, incidence matrices      |   ✅    | `note1.12` |
| Orthogonal vectors and subspaces          |   ✅    | `note2.1`  |
| projections and subspaces                 |   ✅    | `note2.2`  |
| projection matrices and least squares     |   ✅    | `note2.3`  |
| Orthogonal matrices and Gram-Schmidt      |   ✅    | `note2.4`  |

---

# CS61A

an introduction course of computer science

## information

official site: [`site`](https://inst.eecs.berkeley.edu/~cs61a/su20/)
...
|               fucntions                |   ✅    |          `ch1.1\2`           |
|                control                 |   ✅    |         `ch1.3\4\5`          |
|          high-order functions          |   ✅    | `closure` `nested reference` |
|               recursion                |   ✅    | `tree and mutual recursion`  |
|     sequence and data abstraction      |   ✅    |           `ch2.1`            |
| functional decomposition and debugging |   ✅    |         `ch2.1\2\3`          |
|                 trees                  |   ✅    |           `ch2.3`            |
|            mutable sequence            |   ✅    |           `ch2.4`            |
...
| auto-encoder                    |   ✅    |                                                                                                       |
| explainable AI                  |   ✅    |         `local explanation(component, saliency map, probing)`,`global explanation(modelside)`         |  |
| adversarial attack              |   ✅    |                                          `imitation attack`                                           |
| domain adaptation               |   ✅    |               `domain adversarial training`, `DIRT-T`, `maximum classifier discrepancy`               |  |
| reinforcement learning          |   ✅    |                                    `deep q learning`, `PPO`, `AC`                                     |
...
- [x] saliency map(explainable AI)
- [x] domain adversarial training(similar to GAN)
...
|           intro to Rl            |   ✅    | `repo` |
|         policy gradient          |   ✅    | `repo` |
|           actor-critic           |   ✅    | `repo` |
|      value funtion methods       |   ✅    | `repo` |
|     deep RL with Q-functions     |   ✅    | `repo` |

    
extra: `intro to game theory`, `nash equilibrium`, `nash q learning`, `multi agent reinforcement learning`  
*************
...
official homepage: [homepage](https://su20.cs161.org/)
my gitrepo: [github](https://github.com/wyhallenwu/course-projects/tree/main/cs161)

## schedule

|           topic           | status |   other    |
| :-----------------------: | :----: | :--------: |
| intro, security principle |   ✅    | `project1` |
|      buffer overflow      |   ✅    | `project2` |
|   intro to cryptography   |   ✅    |   `repo`   |

## Project

- [x] project1 buffer overflow
- [ ] project2 An End-to-End Encrypted File Sharing System(using golang)
- [ ] project3 exploit website
